...
int main()
{
	UndergraduateStudent* s2 = new UndergraduateStudent(456, "dany", "wilson","Undergraduate");

	GraduateStudent * s3 = new GraduateStudent(123, "sami", "omar", "Graduate");
	...
	obj->print(s3);
    // which printInformation function will be called?
